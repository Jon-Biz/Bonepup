App.module("Data", function(Data){
	...
	App.addInitializer(function(){
		...
		Data.Pages.url = "/?json=get_page_index&custom_fields=Brand,Client,closeup,description,product_image,Product,Varietals,zoomx1,zoomy1,zoomx2,zoomy2";
		Data.Pages.fetch({success: function(collection,resp){
			console.log('collection fetched', resp)
				...
				*/
				...
				WineOne = Products.models[0].get('children').at(0);
